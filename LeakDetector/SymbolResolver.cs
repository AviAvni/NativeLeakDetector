...
namespace LeakDetector
{
    ...
    class NativeTarget : IDisposable
    {
        ...
        public NativeTarget(int processID)
        {
            ...
            string symbolPath = Path.GetDirectoryName(_process.MainModule.FileName) + ";" + Environment.GetEnvironmentVariable("_NT_SYMBOL_PATH");
            if (!SymInitialize(_hProcess, null/*symbolPath*/, invadeProcess: false))
